...
function NewArticleForm() {
  ...
  const selectedCategory = mainCategories.find(c => c.id === formData.categoryId)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/admin/articles/${formData.categoryId}/${formData.subcategoryId}/${articleId}`)
    } catch {
        ...
        <CardContent className="space-y-6">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger>
                  <SelectValue placeholder={formData.categoryId ? "Select a subcategory" : "Select category first"} />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Custom URL path for this article. Letters, numbers, hyphens only. Leave blank to auto-generate.
            </p>

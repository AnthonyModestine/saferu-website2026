...
interface PIOTopBarProps {
  onMenuClick?: () => void
}

export function PIOTopBar({ onMenuClick }: PIOTopBarProps) {
  return (
    <header className="flex h-16 items-center justify-between border-b border-border bg-background px-4 lg:px-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-lg font-semibold text-foreground">Press Center</h1>
      </div>
          ...
          <DropdownMenuContent align="end" className="w-72">
            ...
            <DropdownMenuItem>
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-muted-foreground">
                  Your draft was automatically saved 5 minutes ago
                </span>
              </div>
            </DropdownMenuItem>
          </DropdownMenuContent>
